...
public class TemplateItemBuilder<C> extends MenuItemBuilder {
    ...
    private Map<C, ItemRef> baseItems;
    ...
    public TemplateItemBuilder<C> baseItems(Map<C, ItemRef> baseItems) {
        this.baseItems = baseItems;
        return this;
    }

    public TemplateItemBuilder<C> defaultBaseItem(ItemRef defaultBaseItem) {
