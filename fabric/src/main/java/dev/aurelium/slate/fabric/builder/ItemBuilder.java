...
import dev.aurelium.slate.fabric.function.ItemClicker;
import dev.aurelium.slate.fabric.function.ItemModifier;
import dev.aurelium.slate.fabric.function.ItemReplacer;
import dev.aurelium.slate.fabric.function.MenuListener;
...
public class ItemBuilder {
     ...
     * The name of the placeholder being checked can be accessed using {@link dev.aurelium.slate.fabric.info.PlaceholderInfo#placeholder()}.
     *
     * @param replacer the {@link ItemReplacer} function
     * @return the item builder
     */
