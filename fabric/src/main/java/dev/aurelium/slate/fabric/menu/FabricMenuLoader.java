...
public class FabricMenuLoader extends MenuLoader {

    private final Slate slate;

    public FabricMenuLoader(Slate slate, File mainDir, List<File> mergeDirs) {
        super(slate, mainDir, mergeDirs);
        this.slate = slate;
    }

    @Override
    public LoadedMenu loadMenu(File file, String menuName) throws ConfigurateException {
        ...
        if (!fillSection.virtual()) {
            ...
            fillData = new FillData(FabricFillData.getDefault(slate), null, false);
        }
        // Load components
